...
$(document).ready(function () {
  ...
  if ($(window).width() < 991) {
    $(".category-two .swiper-containeres").addClass("swiper-container");
    $(".category-two .swiper-wrapperr").addClass("swiper-wrapper");
    $(".category-two .swiper-slidee").addClass("swiper-slide");
    var category2 = new Swiper(".category-two .swiper-container", {
      loop: true,
      autoplay: true,
      pagination: {
        el: ".category-two .swiper-pagination",
        clickable: true,
      },
      breakpoints: {
        0: {
